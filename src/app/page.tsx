    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">{t('game_management', '游戏管理')}</h2>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
            {t('game_management_desc', '管理您的游戏组与待玩清单，与好友一起规划您的游戏之旅')}
          </p>
            ...
            >
              ...
              <div className="relative p-8 h-full flex flex-col justify-between z-10">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">{t('game_groups', '游戏组')}</h3>
                  <p className="text-white text-opacity-90">
                    {t('game_groups_desc', '创建和管理您的游戏组，邀请好友共同游玩')}
                  </p>
                </div>
                <div className="mt-6 flex items-center">
                  <span className="text-white font-medium group-hover:underline">
                    {t('manage_groups', '管理我的游戏组')}
                  </span>
            ...
            >
              ...
              <div className="relative p-8 h-full flex flex-col justify-between z-10">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2">{t('game_todo_list', '待玩清单')}</h3>
                  <p className="text-white text-opacity-90">
                    {t('game_todo_list_desc', '管理您想要玩的游戏，记录评分和游戏体验')}
                  </p>
                </div>
                <div className="mt-6 flex items-center">
                  <span className="text-white font-medium group-hover:underline">
                    {t('view_todo_list', '查看我的待玩清单')}
                  </span>
                  <svg className="w-5 h-5 text-white ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
